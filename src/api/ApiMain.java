...
public class ApiMain {
	...
	public static void main(String[] args) throws IOException {
		...
		urlBuilder.append("?" + URLEncoder.encode("serviceKey", "UTF-8") + "=bv8NNvgL2l1rdueDCSIHj6XZI6sEe1cV9YfGyv%2B2NZNZ1sjOHnj%2BcepwLR2zbp8F%2BuDrnHYqqsMzKF1azwOyWA%3D%3D"); /* Service Key */
		...
		rd.close();
		conn.disconnect();
		System.out.println(sb.toString()); //응답받는 코드
