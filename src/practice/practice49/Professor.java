...
public Professor(int profno, String name, String id, String position, int pay, LocalDateTime hiredate, int bonus, int deptno,
...
public void setHiredate(LocalDateTime hirdate) {
